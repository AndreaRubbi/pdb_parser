...
def print_interacting_atoms(di, chain1, chain2):
    ...
    df.to_csv('Interactions_csv/Chain_Inter{a}{b}.csv'.format(a = chain1, b = chain2))
    print(df)
...
'██║██████╔╝███████╗██║ ╚████║   ██║   ██║██║     ██║███████╗██║  ██║', '\n\tBy: Andrea Rubbi', sep = '\n\t'  )
        ...
        print_interacting_atoms(di, chain1, chain2)
        print('\n─────────────────────────────────────────\n')
